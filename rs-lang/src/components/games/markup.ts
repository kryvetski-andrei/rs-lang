...
export const getAudioIconSVG = (size = '', data = ''): string => {
  return `
  <svg xmlns="http://www.w3.org/2000/svg" ${data || `data-audio="${data}"`} version="1.0" width="${
    size || '180'
  }" height="${size || '180'}" viewBox="0 0 75 75">
